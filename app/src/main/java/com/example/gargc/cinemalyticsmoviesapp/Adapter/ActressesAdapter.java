...
public class ActressesAdapter extends RecyclerView.Adapter<ActressesAdapter.MyViewHolder> {
   ...
   public static List<ActorActresses> moviesPosterDetailsList;
    ...
    public ActressesAdapter(Context mContext,List<ActorActresses> moviesPosterDetailsList)
    {
    ...
    @Override
    public ActressesAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.cardviewformoviespart2,parent,false);
        return  new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ActressesAdapter.MyViewHolder holder, int position) {
